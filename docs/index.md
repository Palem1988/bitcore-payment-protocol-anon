...
```
npm install bitcore-lib-anon --save
npm install bitcore-payment-protocol-anon --save
```

For client-side projects:

```
bower install bitcore-lib-anon --save
bower install bitcore-payment-protocol-anon --save
```
